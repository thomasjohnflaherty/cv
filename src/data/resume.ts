...
export const roles: Role[] = [
  {
    ...
    location: "Omaha, NE",
    bullets: [
      "Lead client engagements across insurance, agri-tech, and ERP distribution",
      "Built a Pydantic AI multi-agent service on Cloud Run for an ERP client",
      "Converted an R actuarial rater to Python (GLMs + Black-Scholes) for an insurance MGA",
      "Codified the firm's data-engineering archetype (Modal, Delta Lake, dbt, DuckDB)",
      "Built the team's parallel-subagent codebase-mapping system",
    ],
